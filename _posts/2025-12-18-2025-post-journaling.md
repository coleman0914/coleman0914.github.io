...
Dec 11- 18 in these days
 ...
 Jan 5-9: This week I fixed my documentation errors which Mr. Dubick left feedback for on monday. this included adding some links from youtube and workflows to give more detail about the start of my project. On tuesday and wednesday I started on my task analysis to give me a good timeline for my project and made the outline on google docs- shared with Mr. Dubick. On Thursday and Friday I focused on ordering the necessary parts for my project, which included a Load cell, amplifer, and wood for the stool which I will assemble in a timely fashion from the task analysis I made. The legs have a thickness of 2 by 2 and have a length of roughly 21 or 22 inches each. 

 Friday Jan 9: the wood is ordered and so should the other parts: next week I plan to practice working with the arduinos and practicing using jumpers, LEDS, and a breadboard to get me back in the mindset of coding and using electronics. I may do some work on tinkercad also. 


Week of Jan 12-16: this week the wood came and it was time to get working on the wood component of this project. This involved me measuring and scaling dimensions to make sure that each legs will have the same length. For the width, I need to smooth out the edges of the wood because the legs will need to be round and smooth instead of just the unsmoothed rectangles that they came as. This involves using the cnc machine and the wood trimmers in the lab to complete this portion of the project. Overall this was a good and productive week to get the wood component of my project started. I also watched a video and did some research on cnc machines as I may need to use our cnc machine in my project, but I am not too famaliar with them right now. It is very interesting however and this is the link to the video which I spent the class watching along with talking to Mr. Dubick about future applications with the wood involving joints and other possibilites: https://www.youtube.com/watch?v=_Rt5sC9DrEQ. On thursday I watched Jake rodgers complete his woodcutting with the cnc and followed along with the instructions so I can start using the cnc next week and get started on the wood component. 
