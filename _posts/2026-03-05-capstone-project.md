...
<div class="image-gallery" style="display:grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 15px; margin: 20px 0;">
  <figure>
    <img src="{{ '/assets/images/arduino-code-setup.jpg' | relative_url }}" alt="Arduino code setup showing includes and defines" style="width:100%; height:auto; border-radius: 8px;">
    <figcaption style="font-size: 0.9em; color: #666; margin-top: 8px;">Arduino code setup with HX711 and FastLED libraries, LED pin configuration, and SENSITIVITY set to 80</figcaption>
  </figure>

  <figure>
    <img src="{{ '/assets/images/arduino-code-logic.jpg' | relative_url }}" alt="Arduino loop logic with sensitivity comparison" style="width:100%; height:auto; border-radius: 8px;">
    <figcaption style="font-size: 0.9em; color: #666; margin-top: 8px;">Main loop function showing weight difference calculation and sensitivity threshold logic</figcaption>
  </figure>
</div>
